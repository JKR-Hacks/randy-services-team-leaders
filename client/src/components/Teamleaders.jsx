  ...
  constructor(props) {
    ...
    this.state = {
      ...
      players: {
        ...
        info: {
          seed: '336d993cd7d12ae9', results: 8, page: 1, version: '1.2',
        },
      },
    };
  }
    ...
    if (side === 'Offense') {
        ...
        <div className="col-lg-3 container alert alert-primary text-center">
          ...
          <div className="row col-lg">
            <div className=" text-center border-bottom border-secondary">
              <img src={players.results[0].picture.medium} alt="player" />
          ...
          <div className="row col-lg">
            <div className=" text-center border-bottom border-secondary">
              <img src={players.results[1].picture.medium} alt="player" />
          ...
          <div className="row col-lg">
            <div className=" text-center border-bottom border-secondary">
              <img src={players.results[2].picture.medium} alt="player" />
      ...
      return (
        <div className="col-lg-3 container alert alert-primary text-center">
          ...
          <div className="row col-lg">
            <div className=" text-center border-bottom border-secondary">
              <img src={players.results[4].picture.medium} alt="player" />
          ...
          <div className="row col-lg">
            <div className=" text-center border-bottom border-secondary">
              <img src={players.results[5].picture.medium} alt="player" />
          ...
          <div className="row col-lg">
            <div className=" text-center border-bottom border-secondary">
              <img src={players.results[7].picture.medium} alt="player" />
